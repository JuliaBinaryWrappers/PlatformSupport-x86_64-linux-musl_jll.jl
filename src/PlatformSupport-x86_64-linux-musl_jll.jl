module PlatformSupport-x86_64-linux-musl_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-x86_64-linux-musl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("66e301e3-fadc-58af-8445-bf8d7abcdcfe"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-x86_64-linux-musl", artifacts_toml) for e in artifacts["PlatformSupport-x86_64-linux-musl"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-x86_64-linux-musl; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-x86_64-linux-musl_jll
